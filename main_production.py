...
def run_prod_task(task_file: str | Path, env: str = "test", project: str | None = None) -> dict:
    ...
    update_story_status(
        repo_b_path,
        {
            ...
            "evidence": [str(audit_path), str(story_handoff_path), str(handoff_paths["project_handoff"])],
            "repository": project_id,
        },
    )
    update_story_acceptance_review(
